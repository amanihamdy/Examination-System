...
namespace Examination_System
{
    public partial class Result : Form
    {
        ...
        private void Result_Load(object sender, EventArgs e)
        {
           ...
           adapter = new SqlDataAdapter(cmd);
            ...
            for (int a = 0; a < 10; a++)
            {
                ...
                labels[a].Font = new Font("Times New Roman", 14, FontStyle.Regular);
                this.Controls.Add(labels[a]);
               answers[a].Location = new Point(0, pans);
               answers[a].AutoSize = true;
                answers[a].ForeColor = Color.Black;
                answers[a].Font = new Font("Times New Roman", 14, FontStyle.Regular);
        ...
        {
            this.Hide();
            Student_Home form = new Student_Home(stid);
            form.Show();
        }
    }
}
